              ...
              <div className="no-scrollbar flex items-center bg-gray-100 border border-gray-200 rounded-lg p-1 space-x-1 overflow-x-auto whitespace-nowrap">
                {heldOrderIndices.map((heldIndex, listPosition) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-center space-x-2 px-3 sm:px-5 py-2.5 text-sm font-bold rounded-md transition-all duration-200 focus:outline-none flex-shrink-0 ${
                ...
                {showNewOrderButton && (
                    <button
                        ...
                        className={`px-3 sm:px-5 py-2.5 text-sm font-bold rounded-md transition-all duration-200 focus:outline-none flex-shrink-0 ${
                ...
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-md shadow-lg z-20 border border-gray-200">
                  ...
                  <ul className="max-h-80 overflow-y-auto">
                    {recentInvoices.length > 0 ? (
                      ...
                      <li className="px-4 py-3 text-sm text-gray-500 text-center">No orders today.</li>
                    )}
                  </ul>
                </div>
              )}
