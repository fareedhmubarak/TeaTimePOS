    ...
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-6 py-2 bg-purple-800 text-white rounded-md hover:bg-purple-900 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              Add
            </button>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {categories.length === 0 ? (
            <p className="text-gray-500 text-center py-8">No categories found. Add a category above.</p>
          ) : (
              ...
              {categories.map((category, index) => (
                ...
                >
                  <div className="flex-1 flex items-center gap-3">
                    <span className="text-lg font-semibold text-gray-600 w-8 text-center">
                      {index + 1}
                    </span>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="px-4 py-2 text-red-600 hover:bg-red-100 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
